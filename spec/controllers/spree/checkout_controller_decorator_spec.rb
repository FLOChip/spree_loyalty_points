...
describe Spree::CheckoutController, type: :controller do
  ...
  describe "PUT 'update'" do
    ...
    context "when state is payment" do
      ...
      context "when Mini Points used" do
        ...
        context "when user does not have sufficient Mini Points" do
        ...
        context "when user has sufficient Mini Points" do
      ...
      context "when Mini Points not used" do
