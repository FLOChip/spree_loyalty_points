shared_examples_for "Order::LoyaltyPoints" do
  ...
  describe 'award_loyalty_points' do
    ...
    context "when payment not done via Mini Points" do
    ...
    context "when payment done via Mini Points" do
  ...
  describe 'create_credit_transaction' do
    ...
    context "when quantity is 0" do
      ...
      it "should not add a Mini Points Credit Transaction" do
        expect {
  ...
  describe 'create_debit_transaction' do
    ...
    context "when quantity is 0" do
      ...
      it "should not add a Mini Points Debit Transaction" do
        expect {
  ...
  describe 'loyalty_points_total' do
    ...
    it "should result in net Mini Points for that order" do
