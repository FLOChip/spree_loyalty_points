shared_examples_for "Payment::LoyaltyPoints" do
  ...
  describe 'any_with_loyalty_points?' do
    ...
    context "when payment made using Mini Points" do
    ...
    context "when payment not made using Mini Points" do
  ...
  describe 'redeemable_user_balance' do
    ...
    context "when Mini Points are redeemable" do
    ...
    context "when Mini Points are not redeemable" do
      ...
      it "should add error to loyalty_points_balance" do
        ...
        resource_instance.send(:redeemable_user_balance)
        expect(resource_instance.errors[:loyalty_points_balance]).to eq(["should be atleast #{ min_balance.to_s + " " + "point".pluralize(min_balance) } for redeeming Mini Points"])
      end
