  ...
  describe "validate_transactions_total_range" do
    ...
    context "when transaction_type is Debit" do
      ...
      context "when net_transactions_sum is below range" do
        ...
        it "should return total" do
          ...
          expect(resource_instance.errors[:base].include?("Mini Points Net Debit Total should be in the range [0, #{ first_transaction.loyalty_points }]")).to be_truthy
        end
      ...
      context "when net_transactions_sum is within range" do
        ...
        it "should return total" do
          resource_instance.send(:validate_transactions_total_range, trans_type, relation)
          expect(resource_instance.errors[:base].include?("Mini Points Net Debit Total should be in the range [0, #{ first_transaction.loyalty_points }]")).to be_falsey
        end
    ...
    context "when transaction_type is Credit" do
      ...
      context "when net_transactions_sum is below range" do
        ...
        it "should return total" do
          resource_instance.send(:validate_transactions_total_range, trans_type, relation)
          expect(resource_instance.errors[:base].include?("Mini Points Net Credit Total should be in the range [0, #{ first_transaction.loyalty_points }]")).to be_truthy
        end
      ...
      context "when net_transactions_sum is within range" do
        ...
        it "should return total" do
          resource_instance.send(:validate_transactions_total_range, trans_type, relation)
          expect(resource_instance.errors[:base].include?("Mini Points Net Credit Total should be in the range [0, #{ first_transaction.loyalty_points }]")).to be_falsey
        end
